...
export function MetricCard({ label, value, sublabel }: MetricCardProps) {
  return (
    <div className="rounded-2xl bg-slate/40 p-5 shadow-lg shadow-black/40 border border-white/5 border-t-[3px] border-t-accent/70 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/40 hover:border-white/10">
